<template>
  <div class="grid grid-cols-3 grid-flow-col justify-between items-center mb-7">
    <!-- LOGO -->
    <div class="logo flex">
      <svg
        class="mr-1"
    ...
    <!-- Nav -->
    <nav>
      <ul class="grid grid-cols-5 justify-between">
        <li><a href="#">Home</a></li>
    ...
    <div class="flex justify-end mr-2">
      <button class="btn px-5" v-if="!tripStore.login">
        <router-link to="/login">Login</router-link>
      </button>

      <div class="profilePic flex gap-5" v-if="tripStore.login">
        <img
          src="../assets/images/icons/profile-pic/notification 1.svg"
          alt="notifications icon"
          class="cursor-pointer"
        />
        <img
          src="../assets/images/icons/profile-pic/Ellipse 2.svg"
          alt="profile picture"
          class="cursor-pointer"
        />
      </div>
